        ...
        <div class="col-xs-12">
          <div class="">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat" style="border-radius: 8px;"  id="addproduct"><i class="fa fa-plus"></i> Add Product</a>
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>".$counter."</td>
                            <td>
                              <a href='#description' data-toggle='modal' class='btn btn-info btn-sm btn-flat desc' style='border-radius: 8px;' data-id='".$row['id']."'><i class='fa fa-search'></i> View</a>
